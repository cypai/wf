...
public class ReloadAction extends PerformerAction
		implements DefaultApRequiredComponent, HasPerformerComponent, HasWeaponComponent {
	...
	protected void performImpl() throws IllegalActionException {
		...
		if (agent.getAbilities().hasAbility(QuickReloadAbility.class)
				|| weapon.getGrantedAbilities().hasAbility(QuickReloadAbility.class)) {
